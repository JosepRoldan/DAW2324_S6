                  ...
                  <div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                    <div className="flex-1 overflow-y-auto px-4 py-6 sm:px-6">
                      <div className="flex items-start justify-between">
                        <Dialog.Title className="text-lg font-medium text-gray-900">Purchase details</Dialog.Title>
...
if (document.getElementById('miniCarrito')) {
  createRoot(document.getElementById('miniCarrito')).render(<MiniCarrito />);
}
