    ...
    @section('content')
        <div class="flex items-center justify-center min-h-screen bg-gray-100">
            <div class="max-w-md px-6 py-8 bg-white shadow-md overflow-hidden sm:rounded-lg">
                <h2 class="text-xl font-semibold text-gray-800">Error en la Verificación de Correo Electrónico</h2>
                <p class="mt-2 text-gray-600">El token de verificación proporcionado no es válido o ha expirado.</p>
                <div class="mt-6">
